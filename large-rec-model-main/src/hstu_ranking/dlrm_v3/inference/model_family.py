...
import torchrec
from dlrm_v3.checkpoint import (
    load_nonsparse_checkpoint,
    load_sparse_checkpoint,
)
from dlrm_v3.datasets.dataset import Samples
from dlrm_v3.inference.inference_modules import (
    get_hstu_model,
    HSTUSparseInferenceModule,
    move_sparse_output_to_device,
)
from dlrm_v3.utils import Profiler
from modules.dlrm_hstu import DlrmHSTUConfig, SequenceEmbedding
