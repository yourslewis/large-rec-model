...
import pandas as pd
import torch
from dlrm_v3.datasets.dataset import DLRMv3RandomDataset
...
class DLRMv3KuaiRandDataset(DLRMv3RandomDataset):
    ...
    def get_item_count(self): # return num of lines in the csv file
    ...
    def load_item(self, data, max_num_candidates): # data is a row from the csv file
