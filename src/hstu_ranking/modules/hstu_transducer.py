...
import torch
from common import fx_unwrap_optional_tensor, HammerModule
from modules.positional_encoder import HSTUPositionalEncoder
from modules.postprocessors import (
    L2NormPostprocessor,
    OutputPostprocessor,
)
from modules.preprocessors import InputPreprocessor
from modules.stu import STU
from ops.jagged_tensors import split_2D_jagged
    ...
    def _preprocess(
        ...
        with record_function("hstu_input_preprocessor"):
            (
                ...
                seq_embeddings=seq_embeddings, # content embeddings
